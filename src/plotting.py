...
def plot_a_0_vs_m_f_pi(beta_arr, m_arr, show=False, save = True, pref = ""):
    ...
    f0.write("beta,mass,ampi,ampi_lower,ampi_upper,a0mpi,Delta_a0mpi_lower,Delta_a0mpi_upper,r0mpi,Delta_r0mpi_lower,Delta_r0mpi_upper,mpi_fpi,mpi_fpi_lower,mpi_fpi_upper\n")
    for i in range(len(beta_arr)):
        for j in range(len(beta_arr[i])):
            ...
            f0.write("%f,%f,%e,%e,%e,%e,%e,%e,%e,%e,%e,%e,%e,%e\n"%(beta_arr[i][j],m_arr[i][j],mpi_err[0],mpi_err[1],mpi_err[2],a0mpi_err[0],a0mpi_err[1],a0mpi_err[2], rempi_err[0], rempi_err[1], rempi_err[2],mpifpi_err[0],mpifpi_err[1],mpifpi_err[2] ))
    f0.close()
